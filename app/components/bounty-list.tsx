...
// import { BountyCard } from './bounty-card'; // Assuming you have the Card component from previous step

// export function BountyList() {
//   const { program, wallet } = useGigBoardProgram();
//   const [bounties, setBounties] = useState<any[]>([]);
//   const [loading, setLoading] = useState(true);

//   // Function to fetch data from chain
//   const fetchBounties = async () => {
//     if (!program || !wallet) return;
    
//     try {
//       setLoading(true);
//       // fetch all accounts that match the "Bounty" struct
//       const allBounties = await program.account.bounty.all();
      
//       // Sort: Open bounties first, then by ID
...
//   useEffect(() => {
//     fetchBounties();
//   }, [program, wallet]); // Re-fetch if wallet changes

//   if (loading) return <div className="text-white animate-pulse">Loading Gig Board...</div>;
